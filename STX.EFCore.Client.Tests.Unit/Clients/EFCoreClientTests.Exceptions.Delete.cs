...
namespace STX.EFCore.Client.Tests.Unit.Clients
{
    ...
    {
        [Fact]
        public async Task DeleteAsyncShouldThrowClientValidationExceptionOnValidationErrorAsync()
        {
            // Given
            ...
            operationServiceMock.Setup(service =>
                service.DeleteAsync(someUser, It.IsAny<CancellationToken>()))
                    .ThrowsAsync(operationValidationException);

            // When
            ValueTask<User> Task = efCoreClient.DeleteAsync(someUser);
        ...
        [Fact]
        public async Task DeleteAsyncShouldThrowClientValidationExceptionOnDependencyValidationErrorAsync()
        {
            // Given
            User someUser = CreateRandomUser();
            var someInnerXeption = new Xeption(message: GetRandomString());
        ...
        [Fact]
        public async Task DeleteAsyncShouldThrowClientDependencyExceptionOnDependencyErrorAsync()
        {
            // Given
            User someUser = CreateRandomUser();
            var someInnerXeption = new Xeption(message: GetRandomString());
        ...
        [Fact]
        public async Task DeleteAsyncShouldThrowClientServiceExceptionOnServiceErrorAsync()
        {
            // Given
            User someUser = CreateRandomUser();
            var someInnerXeption = new Xeption(message: GetRandomString());
        ...
        public async Task DeleteAsyncShouldNotWrapOperationCanceledExceptionAsync()
        {
            ...
            operationServiceMock.Setup(service =>
                service.DeleteAsync(someUser, cancelledToken))
                    .ThrowsAsync(new OperationCanceledException());

            // When
            ValueTask<User> Task = efCoreClient.DeleteAsync(someUser, cancelledToken);
