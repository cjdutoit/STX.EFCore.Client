...
namespace STX.EFCore.Client.Tests.Unit.Clients
{
    ...
    {
        [Fact]
        public async Task BulkUpdateAsyncShouldThrowClientValidationExceptionOnValidationErrorAsync()
        {
            // Given
            ...
            operationServiceMock.Setup(service =>
                service.BulkUpdateAsync(someUsers, It.IsAny<bool>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(operationValidationException);

            // When
            ValueTask Task = efCoreClient.BulkUpdateAsync(someUsers);
        ...
        [Fact]
        public async Task BulkUpdateAsyncShouldThrowClientValidationExceptionOnDependencyValidationErrorAsync()
        {
            // Given
            IEnumerable<User> someUsers = CreateRandomUsers();
            var someInnerXeption = new Xeption(message: GetRandomString());
        ...
        [Fact]
        public async Task BulkUpdateAsyncShouldThrowClientDependencyExceptionOnDependencyErrorAsync()
        {
            // Given
            IEnumerable<User> someUsers = CreateRandomUsers();
            var someInnerXeption = new Xeption(message: GetRandomString());
        ...
        [Fact]
        public async Task BulkUpdateAsyncShouldThrowClientServiceExceptionOnServiceErrorAsync()
        {
            // Given
            IEnumerable<User> someUsers = CreateRandomUsers();
            var someInnerXeption = new Xeption(message: GetRandomString());
        ...
        public async Task BulkUpdateAsyncShouldNotWrapOperationCanceledExceptionAsync()
        {
            ...
            operationServiceMock.Setup(service =>
                service.BulkUpdateAsync(someUsers, It.IsAny<bool>(), cancelledToken))
                    .ThrowsAsync(new OperationCanceledException());

            // When
            ValueTask Task =
                efCoreClient.BulkUpdateAsync(someUsers, cancellationToken: cancelledToken);
